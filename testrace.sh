...
install(){
	[[ ! -d /home/testrace/besttrace ]] && wget https://raw.githubusercontent.com/ccgakki/testrace/master/besttrace.tar.gz && tar -zxf besttrace.tar.gz && rm besttrace.tar.gz
...
node_1(){
	...
	[[ "${node}" == "2" ]] && ISP_name="上海电信CN2"	     && ip=58.32.32.1
