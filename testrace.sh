...
install(){
	[[ ! -d /home/testrace/besttrace ]] && wget https://raw.githubusercontent.com/PhilCity/testrace/master/besttrace.tar.gz && tar -zxf besttrace.tar.gz && rm besttrace.tar.gz
